<?php
    ...
    switch ($action){
        ...
        case 'cdc':
            ...
            $poster = "valhaven.jpg"; // default video background for this chapter
            $webm = "ch_1-3.webm"; // webm video file for this chapter
            $mp4 = "ch_1-3.mp4"; // mp4 video file for this chapter
            $ogv = "ch_1-3.ogv"; // ogv video file for this chapter
        ...
        case 'flashback':
            ...
            $mp4 = "ch_1-4.mp4"; // mp4 video file for this chapter
            $ogv = "ch_1-4.ogv"; // ogv video file for this chapter
